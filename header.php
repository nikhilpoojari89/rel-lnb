...
<header>
    <nav class="navbar navbar-expand-lg py-lg-0" id="mainNav">
        <div class="container-fluid justify-content-lg-around aos-init aos-animate">
            ...
            <a class="navbar-brand d-lg-none bg-white ml-4" href="index.php">
            ...
            <div class="navbar-collapse collapse justify-content-start align-self-start py-0 py-lg-0" id="navbarResponsive" style="height: 80px;">
                <div class="navbar-nav gotham-book justify-content-around justify-content-lg-between w-100 flex-lg-column">
             
                    <div class="row justify-content-between">
                        <div class="col-md-12 d-none d-lg-block">
                            <!-- Logo -->
                            <a class="navbar-brand pb-2 ml-2 bg-white" href="index.php">
